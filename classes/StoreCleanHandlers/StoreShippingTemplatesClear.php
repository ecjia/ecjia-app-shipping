...
class StoreShippingTemplatesClear extends StoreCleanAbstract
{
     ...
     * @var string
     */
    protected $code = 'store_shipping_templates_clear';
    ...
    {
        $text = __('将店铺内已添加的所有运费模版全部删除', 'shipping');
        return <<<HTML
...
HTML;
    ...
    public function handleAdminLog()
    {
        ...
        ecjia_admin::admin_log($merchants_name, 'clean', 'store_shipping_template');
    }
