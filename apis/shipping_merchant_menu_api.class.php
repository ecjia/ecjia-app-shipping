...
class shipping_merchant_menu_api extends Component_Event_Api
{
    ...
    public function call(&$options)
    {
        ...
        $submenus = array(
        	ecjia_merchant::make_admin_menu('express_list', __('配送管理'), RC_Uri::url('express/merchant/shipping_template'), 1)->add_purview('ship_merchant_manage')->add_icon('fa-inbox'),
